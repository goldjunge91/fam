---
name: babysit-pr
description: Monitor a pull request through review and CI. Use when the user ask to monitor or watch, babsit a PR.
metadata: 
...
```md
[MODEL-SLUG] RESPONDING ON BEHALF OF MARCO
---
[actual reply]
```
