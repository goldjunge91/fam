...
Review-Reparatur-Spec: `./SPEC-theme-and-semantic-repair.md`
...
Der frühere i18n-Plan wurde durch diesen Initiativenplan ersetzt; die fachliche
Historie bleibt in der zugehörigen Spec dokumentiert.
