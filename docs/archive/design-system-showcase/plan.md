...
Status: Abgeschlossen und archiviert. Die laufenden Styling-Regeln stehen in
`docs/design-system/contracts/` und `AGENTS.md`.
...
Die Referenz erweiterte das vorhandene System. Sie ersetzte weder die zentrale
Theme- noch die UI-API.

## Feste Grenzen

- Unistyles v3 ist die aktive Styling-Runtime; laufende Regeln stehen in
...
4. Screen-, Navigations-, Unistyles-/StyleSheet- und Accessibility-Verträge
