...
| Datei | Zeigt |
| --- | --- |
| `mockup-current-state.html` | Ist-Zustand heute — Referenz, was fehlt |
| `mockup-open-action.html` | Option A: Öffnen-Sheet mit Mengen-Split |
| `mockup-waste-reason.html` | Option A: Wegwerf-Grund-Auswahl + Undo-Toast |
| `mockup-transaction-history.html` | Option A: Gesamt-Verlauf mit Undo |
| `mockup-option-b.html` | Option B (alle 3 Ansichten): Inline-Accordion, Pill-Reihe, Timeline |
...
**Marcos Wahl: Option C** (durchgehende Kantenfarbe als Statusträger,
Vorher/Nachher-Vergleich beim Öffnen, Radio-Auswahlliste bei Wegwerf-Gründen).
