---
name: design-system
description: The visual system for ui — color tokens, typography, spacing, radii, shadows, category colors, and the rules for keeping it consistent. Use when building or auditing any visual surface.
when_to_use:
