...
description: The ui domain model — what a Recipe, Pantry, Ingredient, etc. actually is in this codebase. Read before touching anything that reads or writes recipe data.
when_to_use:
