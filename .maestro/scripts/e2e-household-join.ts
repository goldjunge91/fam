...
// damit gezielt household-join-via-invite.yaml aus. Der Flow bleibt ein
// eigener direkter Fixture-Einstieg, weil kein einzelner Maestro-Flow beide
...
async function main() {
  ...
  process.exit(
    runMaestro([
      'test',
      '.maestro/ios/flows/household/household-join-via-invite.yaml',
      '-e',
      `EMAIL=${joiner.email}`,
      '-e',
