...
/** Absolute Mindestwerte zusaetzlich zum individuellen Grundumsatz. */
...
export type TargetCalorieResult = {
  targetKcal: number;
  /** Wert vor der sichtbaren Sicherheitskappung. */
  uncappedKcal: number;
  capped: boolean;
...
/** Leitet das Ziel aus TDEE und Tempo ab, nie unter Grundumsatz oder Mindestwert. */
