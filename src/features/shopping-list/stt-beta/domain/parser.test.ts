...
describe('parseNaturalLanguageShoppingInput', () => {
  ...
  it.each([
    ['1,5 Liter Milch', [{ name: 'Milch', quantity: 1.5, unit: 'l', brand: null }]],
    ['1.5 Liter Milch', [{ name: 'Milch', quantity: 1.5, unit: 'l', brand: null }]],
    [
      'Bitte Milch und zwei Eier',
      [
        { name: 'Milch', quantity: 1, unit: null, brand: null },
        { name: 'Eier', quantity: 2, unit: null, brand: null },
      ],
    ],
    ['ein halbes Kilo Mehl', [{ name: 'Mehl', quantity: 0.5, unit: 'kg', brand: null }]],
    ['elf Eier', [{ name: 'Eier', quantity: 11, unit: null, brand: null }]],
  ])('parses spoken shopping input %s', (input, items) => {
    expect(parseNaturalLanguageShoppingInput(input)).toEqual({
      items,
      unparsedText: null,
    });
