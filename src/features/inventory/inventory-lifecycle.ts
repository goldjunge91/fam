...
// --- Bestehender Laufzeitpfad (noch kein v1-Cutover) ---
// Diese Typen und Funktionen tragen den aktuellen use-inventory-mutations.ts-
// Pfad. Sie bleiben unverändert neben den v1-Operationstypen unten bestehen,
// bis der Runtime-Cutover (fam-lem.27 Restumfang) sie ablöst; fam-lem.19 war
// ausdrücklich ohne Runtime-Cutover ("kein Legacy-Decoder" gilt erst nach der
// Ablösung, nicht während der Migration selbst).
...
//   transaction: Pick<LifecycleTransaction, 'originItemId' | 'notes'>,
// ): string | null {
//   return transaction.originItemId ?? null;
// }
...
//   if (!canUndoTransaction(createdAt, now))
//     throw new Error('Diese Öffnung kann nicht mehr rückgängig gemacht werden.');
//   if (transaction.undone || transaction.reversalOf || transaction.hasReversal) {
//     throw new Error('Diese Öffnung wurde bereits rückgängig gemacht.');
//   }
