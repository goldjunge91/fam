...
/** Verzoegert den nativen Import, damit ein veralteter Build den App-Start nicht blockiert. */
...
/** Bindet den Token-Refresh an AppState, da iOS Hintergrund-Timer einfriert. */
