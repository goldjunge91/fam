...
export const recipes = sqliteTable(
  'recipes',
  {
    ...
    cheapTips: text('cheap_tips').notNull().default('[]'),
    substitutions: text('substitutions').notNull().default('[]'),
    crispinessLevel: text('crispiness_level'),
    airFryerTimeMinutes: integer('air_fryer_time_minutes'),
    airFryerTemperatureF: integer('air_fryer_temperature_f'),
    variantGroup: text('variant_group'),
    variantType: text('variant_type'),
    dormFriendly: integer('dorm_friendly', { mode: 'boolean' }),
    mealPrepFriendly: integer('meal_prep_friendly', { mode: 'boolean' }),
    whyCheap: text('why_cheap'),
    healthierTips: text('healthier_tips').notNull().default('[]'),
    batchPrepTips: text('batch_prep_tips').notNull().default('[]'),
    optionalAddIns: text('optional_add_ins').notNull().default('[]'),
