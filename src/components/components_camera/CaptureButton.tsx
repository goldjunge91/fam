...
export function CaptureButton({
  ...
  const startRecordingSafely = useCallback(async () => {
    ...
    try {
      ...
      if (startPromise != null && recordingStartPromise.current === startPromise) {
        recordingStartPromise.current = null;
      }
      isRecording.current = false;
      shouldStopAfterStart.current = false;
  ...
  return (
    <GestureDetector gesture={captureGesture}>
      <AnimatedBlurContainer style={[styles.circle, styles.outer, outerStyle]} tint="light">
        <AnimatedBlurContainer style={[styles.circle, styles.inner, innerStyle]} tint="light" />
