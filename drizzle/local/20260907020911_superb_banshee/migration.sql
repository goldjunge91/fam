...
INSERT INTO `__new_transactions`(`id`, `operation_id`, `household_id`, `fridge_item_id`, `product_id`, `actor`, `type`, `quantity`, `location_id`, `reason`, `previous_expiry_date`, `notes`, `undone`, `created_at`, `updated_at`, `deleted_at`, `_dirty`) SELECT `id`, `operation_id`, `household_id`, `fridge_item_id`, `product_id`, `actor`, `type`, `quantity`, `location_id`, `reason`, `previous_expiry_date`, `notes`, `undone`, `created_at`, `updated_at`, `deleted_at`, `_dirty` FROM `transactions`;--> statement-breakpoint
