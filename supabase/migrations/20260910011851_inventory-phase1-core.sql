...
REVOKE ALL ON FUNCTION "public"."apply_inventory_operation"(jsonb) FROM "anon";

REVOKE ALL ON FUNCTION "public"."apply_inventory_operation"(jsonb) FROM "service_role";

COMMENT ON TABLE "public"."fridge_items" IS NULL;

COMMENT ON TABLE "public"."storage_locations" IS NULL;
...
ALTER TABLE "public"."inventory_applied_operations"
  DROP CONSTRAINT "inventory_applied_operations_household_id_fkey";

ALTER TABLE "public"."transactions"
  DROP CONSTRAINT "transactions_quantity_check";

DROP FUNCTION "public"."read_inventory_sync_snapshot"(uuid, uuid[], uuid[]);

DROP TABLE "public"."inventory_applied_operations";
...
exception
  when others then
    get diagnostics v_key = returned_sqlstate;
