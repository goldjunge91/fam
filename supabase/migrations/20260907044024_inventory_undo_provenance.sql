...
REVOKE ALL ON FUNCTION "public"."reverse_move_fridge_item"(uuid, uuid, uuid, uuid, uuid, uuid, numeric, uuid, uuid, timestamp WITH time zone, text) FROM "anon";
...
CREATE UNIQUE INDEX transactions_single_reversal_idx ON public.transactions USING btree (household_id, reversal_of)
